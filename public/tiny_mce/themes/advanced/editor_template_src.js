	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_fonts : "宋体=宋体;楷体_GB2312=楷体_GB2312;黑体=黑体;方正舒体=方正舒体;仿宋_GB2312=仿宋_GB2312;华文彩云=华文彩云;华文细黑=华文细黑;华文新魏=华文新魏;华文行楷=华文行楷;隶书=隶书;微软雅黑=微软雅黑;幼圆=幼圆;Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
